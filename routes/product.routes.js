...
import { getAllProducts, getProductDetails, searchProducts, getMarketDashboard, createProduct } from "../controllers/productController.js";
...
router.post('/dashboard/product/new', upload.single('image'), (req, res) => {
